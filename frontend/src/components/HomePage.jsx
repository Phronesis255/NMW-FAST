...
const HomePage = ({ onSelect }) => {
    return (
        <div className="flex flex-col justify-center items-center h-screen">
            ...
            <div 
                className="card w-96 bg-gradient-to-r from-primary to-secondary text-white shadow-xl mb-4 cursor-pointer transform transition-transform hover:scale-105" 
            ...
            <div 
                className="card w-96 bg-gradient-to-r from-secondary to-accent text-white shadow-xl cursor-pointer transform transition-transform hover:scale-105" 
